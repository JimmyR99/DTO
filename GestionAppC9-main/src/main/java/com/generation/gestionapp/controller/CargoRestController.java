...
public class CargoRestController {
    ...
    @PutMapping("/editar")
    public  ResponseEntity<CargoEditarDTO> editarCargoPorId(@RequestBody CargoEditarDTO cargoParaEditar, @RequestParam long id){
        CargoEditarDTO cargoEditado = cargoService.editarCargoPorId(cargoParaEditar, id);
